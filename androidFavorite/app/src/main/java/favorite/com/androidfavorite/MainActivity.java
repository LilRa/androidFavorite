package favorite.com.androidfavorite;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*string 에 있는 stirng-array 의 adapter 설정*/
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                switch (position) {
                    case 0:
                        ...
                        break;
                    case 1:
                        contantFrame.setBackgroundColor(Color.BLUE);
                        break;
                    case 2:
                        contantFrame.setBackgroundColor(Color.YELLOW);
                        break;
                    case 3:
                        contantFrame.setBackgroundColor(Color.GRAY);
                        break;
                    case 4:
                        contantFrame.setBackgroundColor(Color.CYAN);
                        break;
                    case 5:
                        contantFrame.setBackgroundColor(Color.GREEN);
                        break;
                }
    ...
    public void btnClick(View view) {
        if (view.getId() == R.id.bt_board) {
            viewPager.setCurrentItem(0);
        }
        if (view.getId() == R.id.bt_map) {
